...
RUTA_RESULTADOS <- "D:/Escritorio"
ruta <- "D:/Dropbox/Tesis/Estudio/Resultados/3 Prediccion/"
clasificacion <- FALSE
datos <- cargarDatos()
...
datosModelo$nombre <- nombre
modelos <- readRDS(paste0(ruta, "NOTA_", curso, "/", nombre, "/Modelos.rds"))
modelo <- modelos$SVM_R
graficarRegresor(modelo, datosModelo)
